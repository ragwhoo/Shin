  ...
  return {
    "experimental.chat.system.transform": async (input, output) => {
      output.system.push(
        ...
        "",
        "IMPLEMENTATION TOOLS (edit, write) ARE BLOCKED until review succeeds.",
        "If you try edit/write without review, they will fail.",
        "",
        "AFTER implementation completes:",
        "  - Submit extracted knowledge via bash+curl:",
        "    curl.exe -X POST http://localhost:8080/api/v1/learn",
        "      -H \"Content-Type: application/json\"",
        "      -d '{\"type\":\"experience\",\"title\":\"...\",\"content\":\"...\"}'",
